...
?>
					...
					<div class="content">
						<div class="meist-wrapper" id="meist">
						...
						<div class="golfeesti-wrapper" id="golfeesti">
					...
					<div class="golfikeskused-wrapper" id="golfikeskused">
							<div class="col-xs-12"><h2 class="text-center">EESTI GOLFIKESKUSED</h2></div>

					<div class="kontakt-wrapper" id="kontakt">
