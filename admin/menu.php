					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<div class="navi-wrapper">
							<ul class="lang-selector lang-selector-white">
						        <li>
						        	<a href="/se"><img class="lang-flags" src="../images/se.png"></a><a href="/gb"><img class="lang-flags" src="../images/gb.png"></a><a href="/ru"><img class="lang-flags" src="../images/ru.png"></a>
						        </li>
							</ul>
							...
							<ul class="nav navbar-nav navbar-desktop pull-right">
								<li><a href="culture.php">Kultuuriüritused</a></li>
								<li><a href="incentive.php">Motivatsiooniüritused</a></li>
							</ul>
							<?php endif; ?>
						</div><!-- /.navbar-collapse -->
					</div><!-- /.container-fluid -->
