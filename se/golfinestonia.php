  ...
  <div id="page-id" style="display: none;"><?=$page_id?></div>
				...
				<div class="content">
					...
					<div class="col-xs-12 col-sm-4 submenu-col" id="submenu">
						<ul class="submenu">
						  <li><a onclick="$('#history-content').show(); $('#golfcourses-content').hide();"><img class="submenu-icon" src="images/rahvamuster2.png"><span id="page-1"><?=$page->title;?></span></a></li>
				      <li><a onclick="$('#golfcourses-content').show(); $('#history-content').hide();"><img class="submenu-icon" src="images/rahvamuster2.png"><span id="page-2">Golf courses</span></a></li>
				     </ul>
					</div>
            ...
            <div class="sisu" id="golfcourses-content">
              ...
              <div class="u-smartClear col-xs-12 col-sm-6 golf-couses-block">
                <img id="courses-10" class="courses-img" src="images/courses/courses-10.jpg">

                <div class="sisu" id="golf-and-culture-content">

                  <div id="golf-area" class="col-xs-12 sisu-col-12 golf">
                    <div id="golf-34" class="golf-area" data-id="34">
                      <?=$page10->content;?>
                    </div>
                  </div>
              ...
              <div class="u-smartClear col-xs-12 col-sm-6 golf-couses-block">
                <img id="courses-11" class="courses-img" src="images/courses/courses-11.jpg">

                <div class="sisu" id="golf-and-culture-content">

                  <div id="golf-area" class="col-xs-12 sisu-col-12 golf">
                    <div id="golf-35" class="golf-area" data-id="35">
                      <?=$page11->content;?>
                    </div>
                  </div>
              ...
              <div class="u-smartClear col-xs-12 col-sm-6 golf-couses-block">
                <img id="courses-12" class="courses-img" src="images/courses/courses-12.jpg">

                <div class="sisu" id="golf-and-culture-content">

                  <div id="golf-area" class="col-xs-12 sisu-col-12 golf">
                    <div id="golf-36" class="golf-area" data-id="36">
                      <?=$page12->content;?>
                    </div>
                  </div>
               ...
               <div class="u-smartClear col-xs-12 col-sm-6 golf-couses-block">
                <img id="courses-13" class="courses-img" src="images/courses/courses-13.jpg">

                <div class="sisu" id="golf-and-culture-content">

                  <div id="golf-area" class="col-xs-12 sisu-col-12 golf">
                    <div id="golf-37" class="golf-area" data-id="37">
                      <?=$page13->content;?>
                    </div>
                  </div>
