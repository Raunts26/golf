...
if(isset($_POST['send_form'])) {
  ...
  if($name != "" && $email != "" && $phone != "" && $people != "" && $days != "" && $hotel != "" && $event_list != "" && $info != "") {
    $Register->registerIncentive($name, $email, $phone, $people, $days, $hotel, $event_list, $info);
  }
...
?>
  ...
  <div id="page-id" style="display: none;"><?=$page_id?></div>
            ...
            ?>
              ...
              <div class="col-xs-12">
								<form class="form-horizontal custom-input-group" method="post" action="incentivetours.php">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Please select valid event!</h4>
          </div>
